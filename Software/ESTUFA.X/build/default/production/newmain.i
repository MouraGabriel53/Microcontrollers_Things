...
void conv_SU(){
    ...
    while(ADCON0bits.GO);
    VdigADC_SU = ADRESH;
    VdigADC_SU = (VdigADC_SU << 8) + ADRESL;
...
void conv_ST(){
    ...
    while(ADCON0bits.GO);
    VdigADC_ST = ADRESH;
    VdigADC_ST = (VdigADC_ST << 8) + ADRESL;
...
void main(void)
{
    ...
    while(1)
    {
        ...
        else if(VdigADC_SU > 338 && VdigADC_SU <= 614)
        {
        ...
        else if(VdigADC_ST > 256 && VdigADC_ST <= 512)

       {
        ...
        else if(VdigADC_ST > 512 && VdigADC_ST <= 767)
