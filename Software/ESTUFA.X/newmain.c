...
unsigned int VdigADC_SU, 
             VdigADC_ST; //4 Bytes de armazenamento
...
void main(void) 
{
    ...
    while(1)
    {
        ...
        if(VdigADC_SU <= 338) //101010010 = 338 = aprox. 33% de 1023
        {
        ...
        else if(VdigADC_SU > 338 && VdigADC_SU <= 614) //1001100110 = 614 = aprox. 60% de 1023
        {
        ...
        if(VdigADC_ST <= 256) //100000000 = 256 = 25% de 1023 = 1.25V
        {
        ...
        else if(VdigADC_ST > 256 && VdigADC_ST <= 512) //1000000000 = 512 = 50% de 1023 = 2.5V
        
       {
        ...
        else if(VdigADC_ST > 512 && VdigADC_ST <= 767) //1011111111 = 767 = 75% de 1023 = 3.75V
